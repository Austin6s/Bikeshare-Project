...
I used the latest versions of all of these packages:

time; sys; pandas: version=1.3.2

## Installation

For this project I used [Anaconda](https://www.anaconda.com/) to install the necessary packages needed to complete this project.
